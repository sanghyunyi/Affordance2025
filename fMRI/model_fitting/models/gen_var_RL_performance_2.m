...
for t=1:T
    ...
    ppe_aff_list(t) = o*p_aff(a)/(p_all(a)+1e-64) - I_aff;
    ppe_q_list(t) = o*p_q(a)/(p_all(a)+1e-64) - I_nonaff;
...
subj.ppe_aff_list = ppe_aff_list;
subj.ppe_q_list = ppe_q_list;
